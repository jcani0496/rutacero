        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-md">
                ...
                <div className="space-y-4 py-4">
                    {featureType === 'debt' && currentCount !== undefined && maxAllowed !== undefined && (
                        <div className="flex items-center justify-center gap-4 rounded-xl bg-muted p-4">
                            ...
                            <div className="text-center">
                                <p className="text-3xl font-bold text-foreground">{maxAllowed}</p>
                ...
                <DialogFooter className="flex-col gap-2 sm:flex-row">
                    ...
                    <Button asChild className="w-full sm:w-auto bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600">
