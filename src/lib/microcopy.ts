...
export const ALERTS = {
  // Pagos próximos
  PAYMENT_DUE_TODAY: "Tenés un pago programado para hoy. ¡No lo olvides!",
  PAYMENT_DUE_TOMORROW: "Mañana vence tu pago a {creditor}. Preparáte.",
  PAYMENT_DUE_SOON: "Tu pago a {creditor} vence en {days} días.",
  PAYMENT_OVERDUE: "Tu pago a {creditor} está vencido. Pagá lo antes posible para evitar intereses adicionales.",

  // Flujo de caja
  INSUFFICIENT_CASH: "Tu caja proyectada para {period} es baja. Considerá ajustar tus gastos variables.",
  ...
  BUDGET_EXCEEDED: "Excediste tu presupuesto de {category} por {amount}.",

  // Plan
  PLAN_DEVIATION: "Te desviaste del plan. Considerá hacer un pago extra para retomar el rumbo.",
  PLAN_ON_TRACK: "¡Vas por buen camino! Mantené el ritmo.",
  PLAN_AHEAD: "¡Excelente! Estás adelantado en tu plan de pagos.",
  PLAN_COVERS: "Este pago cubre tu plan.",
  PLAN_PAYMENT_AHEAD: "Este pago adelanta tu plan.",
  PLAN_PAYMENT_SHORT: "Este pago no cubre del todo tu plan.",

  // Victorias
  DEBT_PAID_OFF: "¡Felicidades! Liquidaste tu deuda con {creditor}.",
  MILESTONE_REACHED: "¡Hito alcanzado! Pagaste {amount} de deuda total.",
} as const;
...
export const VALIDATION_ERRORS = {
  ...
  REQUIRED_EMAIL: "Ingresá tu correo electrónico.",
  REQUIRED_AMOUNT: "Ingresá un monto.",
  REQUIRED_DATE: "Seleccioná una fecha.",
  REQUIRED_CREDITOR: "Ingresá el nombre del acreedor.",

  // Formato inválido
  INVALID_EMAIL: "El correo electrónico no es válido.",
  INVALID_AMOUNT: "El monto debe ser un número positivo.",
  INVALID_DATE: "La fecha no es válida. Usá formato DD/MM/AAAA.",
  ...
  DUPLICATE_CREDITOR: "Ya tenés una deuda registrada con este acreedor.",
  BALANCE_REQUIRED: "Ingresá el saldo actual de la deuda.",
  MIN_PAYMENT_REQUIRED: "Ingresá el pago mínimo mensual.",
} as const;
...
export const PAST_DUE_MESSAGES = {
  // Usuario
  SUBSCRIPTION_PAST_DUE: "Tu suscripción está vencida. Actualizá tu método de pago para continuar.",
  SUBSCRIPTION_GRACE_PERIOD: "Tu pago no pudo procesarse. Tenés {days} días para actualizar tu método de pago.",
  SUBSCRIPTION_SUSPENDED: "Tu cuenta está suspendida por falta de pago. Actualizá tu método de pago para reactivar.",
  SUBSCRIPTION_CANCELED: "Tu suscripción fue cancelada. Podés reactivarla en cualquier momento.",
...
export const CONFIRMATION_MESSAGES = {
  DELETE_DEBT: "¿Seguro que querés eliminar esta deuda? Esta acción no se puede deshacer.",
  CANCEL_SUBSCRIPTION: "¿Seguro que querés cancelar tu suscripción? Perderás acceso a funciones Pro.",
  CHANGE_PLAN: "¿Cambiar tu estrategia de pago? Se recalculará tu plan.",
  LOG_OUT: "¿Seguro que querés cerrar sesión?",
...
export const EMPTY_STATES = {
  NO_DEBTS: {
    ...
    description: "Agregá tu primera deuda para empezar a planificar tu camino a la libertad financiera.",
    action: "Agregar deuda",
  },
  NO_PLAN: {
    title: "Sin plan activo",
    description: "Generá un plan personalizado para salir de deudas más rápido.",
    action: "Generar plan",
  },
  NO_ALERTS: {
    title: "Todo en orden",
  ...
  NO_PAYMENTS: {
    ...
    description: "Cuando registres un pago del plan, aparecerá acá. Empezá con el monto sugerido desde Mi Plan.",
    action: "Registrar pago",
  },
  NO_RESULTS: {
    title: "Sin resultados",
    description: "No encontramos lo que buscás. Probá con otros términos.",
  },
  SAMPLE_DATA: {
    title: "Datos de ejemplo",
    description: "Estás viendo deudas e ingresos de muestra. No son tus datos reales — podés eliminarlos cuando quieras.",
    action: "Eliminar datos de ejemplo",
  },
} as const;
...
export const HELP_TEXT = {
  ...
  AVALANCHE: "Prioriza las deudas con mayor tasa de interés. Pagás menos interés total.",
